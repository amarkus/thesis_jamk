...
class Demonstration:
    ...
    def __init__(
        ...
        evaluation_result_dir="src/reports/demonstration",
        normal_images_path="src/dataset/demonstration_patches/original",
        adversarial_images_path="src/dataset/demonstration_patches/adversarial",
    ):
        # Common properties
